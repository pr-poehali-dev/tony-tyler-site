...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-deep-black text-white font-open-sans">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-deep-black/90 backdrop-blur-sm z-50 border-b border-electric-orange/20">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="text-3xl font-oswald font-bold text-electric-orange">
              TONY TYLER
            </div>
            <div className="hidden md:flex space-x-8">
              {["Главная", "О группе", "Концерты", "Музыка", "Фото", "Контакты"].map((item) => (
                <a key={item} href="#" className="hover:text-electric-orange transition-colors duration-300">
                  {item}
                </a>
              ))}
            </div>
            <Button className="bg-electric-orange hover:bg-electric-orange/90 text-deep-black font-semibold">
              Купить билеты
            </Button>
          </div>
        </div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative text-center z-10 animate-fade-in">
          ...
          <p className="text-2xl md:text-3xl mb-8 text-electric-orange font-oswald">
            HEAVY METAL LEGENDS
          </p>
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-electric-orange hover:bg-electric-orange/90 text-deep-black font-semibold text-lg px-8 py-4 animate-pulse-glow">
              <Icon name="Play" size={20} className="mr-2" />
              Послушать музыку
            </Button>
            <Button size="lg" variant="outline" className="border-electric-orange text-electric-orange hover:bg-electric-orange hover:text-deep-black text-lg px-8 py-4">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-5xl font-oswald font-bold mb-6 text-electric-orange">
                О группе
              </h2>
        ...
        <div className="max-w-6xl mx-auto">
          <Tabs defaultValue="concerts" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-rock-gray/50 mb-12">
              <TabsTrigger value="concerts" className="data-[state=active]:bg-electric-orange data-[state=active]:text-deep-black">
                <Icon name="Calendar" size={20} className="mr-2" />
                Концерты
              </TabsTrigger>
              <TabsTrigger value="music" className="data-[state=active]:bg-electric-orange data-[state=active]:text-deep-black">
                <Icon name="Music" size={20} className="mr-2" />
                Музыка
              </TabsTrigger>
              <TabsTrigger value="gallery" className="data-[state=active]:bg-electric-orange data-[state=active]:text-deep-black">
            ...
            <TabsContent value="concerts" className="space-y-6">
              <h2 className="text-4xl font-oswald font-bold text-electric-orange mb-8">
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <div className="flex items-center gap-4 mb-2">
                            <Icon name="Calendar" size={24} className="text-electric-orange" />
                            <h3 className="text-2xl font-oswald font-semibold">{concert.date}</h3>
                          </div>
                          <div className="flex items-center gap-4 mb-2">
                            <Icon name="MapPin" size={20} className="text-electric-orange" />
                            <span className="text-lg">{concert.venue}, {concert.city}</span>
                          </div>
                          <div className="flex items-center gap-4">
                            <Icon name="DollarSign" size={20} className="text-electric-orange" />
            ...
            <TabsContent value="music" className="space-y-6">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <Button 
                            size="sm" 
                            variant="outline"
                            className="border-electric-orange text-electric-orange hover:bg-electric-orange hover:text-deep-black"
                        ...
                        <div className="flex items-center gap-2">
                          <Icon name="Download" size={16} className="text-electric-orange" />
              ...
              {/* Audio Player */}
              {currentTrack && (
                <Card className="bg-electric-orange/10 border-electric-orange">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="flex gap-2">
                          <Button size="sm" variant="outline" className="border-electric-orange text-electric-orange">
                            <Icon name="SkipBack" size={16} />
                          </Button>
                          <Button 
                            size="sm" 
                            className="bg-electric-orange text-deep-black"
                      ...
                      <div className="flex items-center gap-4">
                        <Icon name="Volume2" size={20} className="text-electric-orange" />
                        <div className="w-24 h-2 bg-rock-gray rounded-full">
                          <div className="w-3/4 h-full bg-electric-orange rounded-full" />
                        </div>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {gallery.map((image, index) => (
                  <div key={index} className="relative group overflow-hidden rounded-lg">
                    ...
                    />
                    <div className="absolute inset-0 bg-electric-orange/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <Button size="sm" className="bg-electric-orange text-deep-black">
                ...
                {[1,2,3,4].map((index) => (
                  <div key={`placeholder-${index}`} className="relative group overflow-hidden rounded-lg bg-rock-gray/30">
                    <div className="w-full h-64 flex items-center justify-center">
                      <Icon name="Camera" size={48} className="text-electric-orange opacity-50" />
                    </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <Icon name="Mail" size={32} className="text-electric-orange mx-auto mb-4" />
              <h4 className="text-lg font-semibold mb-2">Email</h4>
              <p className="text-gray-400">booking@tonytyler.ru</p>
            </div>
            <div className="text-center">
              <Icon name="Phone" size={32} className="text-electric-orange mx-auto mb-4" />
              <h4 className="text-lg font-semibold mb-2">Телефон</h4>
              <p className="text-gray-400">+7 (495) 123-45-67</p>
            </div>
            <div className="text-center">
              <Icon name="Instagram" size={32} className="text-electric-orange mx-auto mb-4" />
      ...
      {/* Footer */}
      <footer className="py-8 px-6 bg-deep-black border-t border-electric-orange/20">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <p className="text-gray-400">© 2024 TONY TYLER. Все права защищены.</p>
          <div className="flex space-x-6">
            {['Facebook', 'Instagram', 'Youtube'].map((social) => (
              <a key={social} href="#" className="text-gray-400 hover:text-electric-orange transition-colors">
